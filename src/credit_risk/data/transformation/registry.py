...
class TransformerRegistry(Registry):
    ...
    def _register_defaults(cls) -> None:
        ...
        from credit_risk.data.transformation.credit_card import CreditCardBalanceTransformer
        ...
        from credit_risk.data.transformation.pos_cash import POSCashBalanceTransformer
